...
Session2=pd.read_csv('Session2/Session2.csv')
## deleting all the cross and Explanation

#delete user 16
Ses_All_File_except16=Session2.Users!='16_User'
Ses_All_File_2=Session2[Ses_All_File_except16]

Ses_All_File_2.to_csv('Exported_Dataset_Ses_2/Ses_All_File_2.csv',index=False)
Media_1=Ses_All_File_2.MEDIA_NAME=='Media1'
Slide_1=Ses_All_File_2[Media_1]
Media_2=Ses_All_File_2.MEDIA_NAME=='Media2'
Slide_2=Ses_All_File_2[Media_2]
Media_3=Ses_All_File_2.MEDIA_NAME=='Media3'
Slide_3=Ses_All_File_2[Media_3]
Media_4=Ses_All_File_2.MEDIA_NAME=='Media4'
Slide_4=Ses_All_File_2[Media_4]
Media_5=Ses_All_File_2.MEDIA_NAME=='Media5'
Slide_5=Ses_All_File_2[Media_5]
Media_6=Ses_All_File_2.MEDIA_NAME=='Media6'
Slide_6=Ses_All_File_2[Media_6]
Media_7=Ses_All_File_2.MEDIA_NAME=='Media7'
Slide_7=Ses_All_File_2[Media_7]
Media_8=Ses_All_File_2.MEDIA_NAME=='Media8'
Slide_8=Ses_All_File_2[Media_8]
Media_9=Ses_All_File_2.MEDIA_NAME=='Media9'
Slide_9=Ses_All_File_2[Media_9]
Media_10=Ses_All_File_2.MEDIA_NAME=='Media10'
Slide_10=Ses_All_File_2[Media_10]


Slides_mod2=[Slide_1,Slide_2,Slide_3,Slide_4,Slide_5,Slide_6,
          Slide_7,Slide_8,Slide_9,Slide_10]
Slides1_Ses_2=pd.concat(Slides_mod2,axis=0)
Slides1_Ses_2.to_csv('Exported_Dataset_Ses_2/Slides1_Ses_2.csv',index=False)

#-------Locate only fixation data-------------
Fix_file_Ses1=Slides1_Ses_2.USER=='U_fix'
Fix_Ses1=Slides1_Ses_2[Fix_file_Ses1]
Fix_file_final_Ses2=Fix_Ses1.loc[:,['Users','MEDIA_NAME','FPOGX','FPOGY']]
Fix_file_final_Ses2.to_csv('Exported_Dataset_Ses_2/Fix_file_final_Ses2.csv',index=False)
...
for i in range(0,31):  
    ...
    user_data=Fix_file_final_Ses2.Users==list_of_users[i]
    users=Fix_file_final_Ses2[user_data]
    ...
    nextPoint1=0   # The next fixation point wit in the slide
    
    for point in range(len(Data_X1)):
        if(0<Data_X1.values[point]) and (Data_X1.values[point]<=b1) and ((26/1080)<Data_Y1.values[point]) and (Data_Y1.values[point]<=(0.5)):
            c=[Data_X1.values[point],Data_Y1.values[point]]
            #print(c)
            c1[0]+=1
        elif(b1<Data_X1.values[point]) and (Data_X1.values[point]<=b2) and((26/1080)<Data_Y1.values[point]) and (Data_Y1.values[point]<=(0.5)):
            a=[Data_X1.values[point],Data_Y1.values[point]]
            c1[1]+=1
        elif(b2<Data_X1.values[point]) and (Data_X1.values[point]<=1)and ((26/1080)<Data_Y1.values[point]) and (Data_Y1.values[point]<=(0.5)):
            c1[2]+=1
        elif(0<Data_X1.values[point]) and (Data_X1.values[point]<=b1)and (0.5<Data_Y1.values[point]) and (Data_Y1.values[point]<=(1054/1080)):
            c1[3]+=1
        elif(b1<Data_X1.values[point]) and (Data_X1.values[point]<=b2)and (0.5<Data_Y1.values[point]) and (Data_Y1.values[point]<=(1054/1080)):
            c1[4]+=1
        elif(b2<Data_X1.values[point]) and (Data_X1.values[point]<=1) and (0.5<Data_Y1.values[point]) and (Data_Y1.values[point]<=(1054/1080)):
            c1[5]+=1
    ...
    D2=0  #......the average distance among all consecutive fixation points
    nextPoint2=0#... The next fixation point
    for point2 in range(len(Data_X2)):
        if (((66/1920)<Data_X2.values[point2]) and (Data_X2.values[point2]<=(662/1920))) and ((0<Data_Y2.values[point2]) and (Data_Y2.values[point2]<=(0.5))):#A1
            c2[0]+=1
        elif((662/1920)<Data_X2.values[point2]) and (Data_X2.values[point2]<=(1258/1920)) and(0<Data_Y2.values[point2]) and (Data_Y2.values[point2]<=(0.5)):#A2
            #a=[Data_X2.values[point2],Data_Y2.values[point2]]
            c2[1]+=1
        elif((1258/1920)<Data_X2.values[point2]) and (Data_X2.values[point2]<=(1854/1920))and (0<Data_Y2.values[point2]) and (Data_Y2.values[point2]<=(0.5)):#A3
            c2[2]+=1
            d=[Data_X2.values[point2],Data_Y2.values[point2]]
            #print("D... ",d)
        elif((66/1920)<Data_X2.values[point2]) and (Data_X2.values[point2]<=(662/1920))and (0.5<Data_Y2.values[point2]) and (Data_Y2.values[point2]<=(1)):#A4
            c2[3]+=1
        elif((662/1920)<Data_X2.values[point2]) and (Data_X2.values[point2]<=(1258/1920))and (0.5<Data_Y2.values[point2]) and (Data_Y2.values[point2]<=(1)):#A5
            c2[4]+=1
            e=[Data_X2.values[point2],Data_Y2.values[point2]]
        elif((1258/1920)<Data_X2.values[point2]) and (Data_X2.values[point2]<=(1854/1920)) and (0.5<Data_Y2.values[point2]) and (Data_Y2.values[point2]<=(1)):#A6
            c2[5]+=1
            a6=[Data_X2.values[point2],Data_Y2.values[point2]]
    ...
    for point3 in range(len(Data_X3)):
        if (((24/1920)<Data_X3.values[point3]) and (Data_X3.values[point3]<=(648/1920))) and ((0<Data_Y3.values[point3]) and (Data_Y3.values[point3]<=(0.5))):#A1
            c3[0]+=1
        elif((648/1920)<Data_X3.values[point3]) and (Data_X3.values[point3]<=(1272/1920)) and(0<Data_Y3.values[point3]) and (Data_Y3.values[point3]<=(0.5)):#A2
            a=[Data_X3.values[point3],Data_Y3.values[point3]]
            c3[1]+=1
        elif((1272/1920)<Data_X3.values[point3]) and (Data_X3.values[point3]<=(1896/1920))and (0<Data_Y3.values[point3]) and (Data_Y3.values[point3]<=(0.5)):#A3
            c3[2]+=1
        elif((24/1920)<Data_X3.values[point3]) and (Data_X3.values[point3]<=(648/1920))and (0.5<Data_Y3.values[point3]) and (Data_Y3.values[point3]<=(1)):#A4
            c3[3]+=1
        elif((648/1920)<Data_X3.values[point3]) and (Data_X3.values[point3]<=(1272/1920))and (0.5<Data_Y3.values[point3]) and (Data_Y3.values[point3]<=(1)):#A5
            c3[4]+=1
        elif((1272/1920)<Data_X3.values[point3]) and (Data_X3.values[point3]<=(1896/1920)) and (0.5<Data_Y3.values[point3]) and (Data_Y3.values[point3]<=(1)):#A6
            c3[5]+=1
    ...
    for point4 in range(len(Data_X4)):
        if (((90/1920)<Data_X4.values[point4]) and (Data_X4.values[point4]<=(670/1920))) and ((0<Data_Y4.values[point4]) and (Data_Y4.values[point4]<=(0.5))):#A1
            c4[0]+=1
        elif((670/1920)<Data_X4.values[point4]) and (Data_X4.values[point4]<=(1250/1920)) and(0<Data_Y4.values[point4]) and (Data_Y4.values[point4]<=(0.5)):#A2
            a=[Data_X4.values[point4],Data_Y4.values[point4]]
            c4[1]+=1
        elif((1250/1920)<Data_X4.values[point4]) and (Data_X4.values[point4]<=(1830/1920))and ((0)<Data_Y4.values[point4]) and (Data_Y4.values[point4]<=(0.5)):#A3
            c4[2]+=1
        elif((90/1920)<Data_X4.values[point4]) and (Data_X4.values[point4]<=(670/1920))and (0.5<Data_Y4.values[point4]) and (Data_Y4.values[point4]<=(1)):#A4
            c4[3]+=1
        elif((670/1920)<Data_X4.values[point4]) and (Data_X4.values[point4]<=(1250/1920))and (0.5<Data_Y4.values[point4]) and (Data_Y4.values[point4]<=(1)):#A5
            c4[4]+=1
        elif((1250/1920)<Data_X4.values[point4]) and (Data_X4.values[point4]<=(1830/1920)) and (0.5<Data_Y4.values[point4]) and (Data_Y4.values[point4]<=(1)):#A6
            c4[5]+=1
    ...
    for point5 in range(len(Data_X5)):
        if (((72/1920)<Data_X5.values[point5]) and (Data_X5.values[point5]<=(664/1920))) and ((0<Data_Y5.values[point5]) and (Data_Y5.values[point5]<=(0.5))):#A1
            c5[0]+=1
        elif((664/1920)<Data_X5.values[point5]) and (Data_X5.values[point5]<=(1256/1920)) and(0<Data_Y5.values[point5]) and (Data_Y5.values[point5]<=(0.5)):#A2
            a=[Data_X5.values[point5],Data_Y5.values[point5]]
            c5[1]+=1
        elif((1256/1920)<Data_X5.values[point5]) and (Data_X5.values[point5]<=(1848/1920))and ((0)<Data_Y5.values[point5]) and (Data_Y5.values[point5]<=(0.5)):#A3
            c5[2]+=1
        elif((72/1920)<Data_X5.values[point5]) and (Data_X5.values[point5]<=(664/1920))and (0.5<Data_Y5.values[point5]) and (Data_Y5.values[point5]<=(1)):#A4
            c5[3]+=1
        elif((664/1920)<Data_X5.values[point5]) and (Data_X5.values[point5]<=(1256/1920))and (0.5<Data_Y5.values[point5]) and (Data_Y5.values[point5]<=(1)):#A5
            c5[4]+=1
        elif((1256/1920)<Data_X5.values[point5]) and (Data_X5.values[point5]<=(1848/1920)) and (0.5<Data_Y5.values[point5]) and (Data_Y5.values[point5]<=(1)):#A6
            c5[5]+=1
    ...
    for point6 in range(len(Data_X6)):
        if ((0<Data_X6.values[point6]) and (Data_X6.values[point6]<=(b1)) and ((4/1080)<Data_Y6.values[point6]) and (Data_Y6.values[point6]<=(0.5))):#A1
            c6[0]+=1
        elif((b1)<Data_X6.values[point6]) and (Data_X6.values[point6]<=(b2)) and((4/1080)<Data_Y6.values[point6]) and (Data_Y6.values[point6]<=(0.5)):#A2
            a=[Data_X6.values[point6],Data_Y6.values[point6]]
            c6[1]+=1
        elif((b2)<Data_X6.values[point6]) and (Data_X6.values[point6]<=(1))and ((4/1080)<Data_Y6.values[point6]) and (Data_Y6.values[point6]<=(0.5)):#A3
            c6[2]+=1
        elif(0<Data_X6.values[point6]) and (Data_X6.values[point6]<=(b1))and (0.5<Data_Y6.values[point6]) and (Data_Y6.values[point6]<=(1076/1080)):#A4
            c6[3]+=1
        elif((b1)<Data_X6.values[point6]) and (Data_X6.values[point6]<=(b2))and (0.5<Data_Y6.values[point6]) and (Data_Y6.values[point6]<=(1076/1080)):#A5
            c6[4]+=1
        elif((b2)<Data_X6.values[point6]) and (Data_X6.values[point6]<=(1)) and (0.5<Data_Y6.values[point6]) and (Data_Y6.values[point6]<=(1076/1080)):#A6
            c6[5]+=1
    ...
    for point7 in range(len(Data_X7)):
        if((70/1920)<Data_X7.values[point7]) and (Data_X7.values[point7]<=(663/1920)) and ((0)<Data_Y7.values[point7]) and (Data_Y7.values[point7]<=(0.5)):
            c7[0]+=1
        elif((663/1920)<Data_X7.values[point7]) and (Data_X7.values[point7]<=(1257/1920)) and((0)<Data_Y7.values[point7]) and (Data_Y7.values[point7]<=(0.5)):
            c7[1]+=1
        elif((1257/1920)<Data_X7.values[point7]) and (Data_X7.values[point7]<=(1850/1920))and ((0)<Data_Y7.values[point7]) and (Data_Y7.values[point7]<=(0.5)):
            c7[2]+=1
        elif((70/1920)<Data_X7.values[point7]) and (Data_X7.values[point7]<=(663/1920))and (0.5<Data_Y7.values[point7]) and (Data_Y7.values[point7]<=(1)):
            c7[3]+=1
        elif((663/1920)<Data_X7.values[point7]) and (Data_X7.values[point7]<=(1257/1920))and (0.5<Data_Y7.values[point7]) and (Data_Y7.values[point7]<=(1)):
            c7[4]+=1
        elif((1257/1920)<Data_X7.values[point7]) and (Data_X7.values[point7]<=(1850/1920)) and (0.5<Data_Y7.values[point7]) and (Data_Y7.values[point7]<=(1)):
            c7[5]+=1
    ...
    for point8 in range(len(Data_X8)):
        if (((210/1920)<Data_X8.values[point8]) and (Data_X8.values[point8]<=(710/1920))) and ((0<Data_Y8.values[point8]) and (Data_Y8.values[point8]<=(0.5))):#A1
            c8[0]+=1
        elif((710/1920)<Data_X8.values[point8]) and (Data_X8.values[point8]<=(1210/1920)) and(0<Data_Y8.values[point8]) and (Data_Y8.values[point8]<=(0.5)):#A2
            c8[1]+=1
        elif((1210/1920)<Data_X8.values[point8]) and (Data_X8.values[point8]<=(1710/1920))and (0<Data_Y8.values[point8]) and (Data_Y8.values[point8]<=(0.5)):#A3
            c8[2]+=1
        elif((210/1920)<Data_X8.values[point8]) and (Data_X8.values[point8]<=(710/1920))and (0.5<Data_Y8.values[point8]) and (Data_Y8.values[point8]<=(1)):#A4
            c8[3]+=1
        elif((710/1920)<Data_X8.values[point8]) and (Data_X8.values[point8]<=(1210/1920))and (0.5<Data_Y8.values[point8]) and (Data_Y8.values[point8]<=(1)):#A5
            c8[4]+=1
        elif((1210/1920)<Data_X8.values[point8]) and (Data_X8.values[point8]<=(1710/1920)) and (0.5<Data_Y8.values[point8]) and (Data_Y8.values[point8]<=(1)):#A6
            c8[5]+=1
    ...
    for point9 in range(len(Data_X9)):
        if (((14/1920)<Data_X9.values[point9]) and (Data_X9.values[point9]<=(645/1920))) and ((0<Data_Y9.values[point9]) and (Data_Y9.values[point9]<=(0.5))):#A1
            c9[0]+=1
        elif((645/1920)<Data_X9.values[point9]) and (Data_X9.values[point9]<=(1275/1920)) and(0<Data_Y9.values[point9]) and (Data_Y9.values[point9]<=(0.5)):#A2
            a=[Data_X9.values[point9],Data_Y9.values[point9]]
            c9[1]+=1
        elif((1275/1920)<Data_X9.values[point9]) and (Data_X9.values[point9]<=(1906/1920))and (0<Data_Y9.values[point9]) and (Data_Y9.values[point9]<=(0.5)):#A3
            c9[2]+=1
        elif((14/1920)<Data_X9.values[point9]) and (Data_X9.values[point9]<=(645/1920))and (0.5<Data_Y9.values[point9]) and (Data_Y9.values[point9]<=(1)):#A4
            c9[3]+=1
        elif((645/1920)<Data_X9.values[point9]) and (Data_X9.values[point9]<=(1275/1920))and (0.5<Data_Y9.values[point9]) and (Data_Y9.values[point9]<=(1)):#A5
            c9[4]+=1
        elif((1275/1920)<Data_X9.values[point9]) and (Data_X9.values[point9]<=(1906/1920)) and (0.5<Data_Y9.values[point9]) and (Data_Y9.values[point9]<=(1)):#A6
            c9[5]+=1
    ...
    for point10 in range(len(Data_X10)):
        if (((275/1920)<Data_X10.values[point10]) and (Data_X10.values[point10]<=(732/1920))) and ((0<Data_Y10.values[point10]) and (Data_Y10.values[point10]<=(0.5))):#A1
            c10[0]+=1
        elif((732/1920)<Data_X10.values[point10]) and (Data_X10.values[point10]<=(1188/1920)) and(0<Data_Y10.values[point10]) and (Data_Y10.values[point10]<=(0.5)):#A2
            a=[Data_X10.values[point10],Data_Y10.values[point10]]
            c10[1]+=1
        elif((1188/1920)<Data_X10.values[point10]) and (Data_X10.values[point10]<=(1645/1920))and (0<Data_Y10.values[point10]) and (Data_Y10.values[point10]<=(0.5)):#A3
            c10[2]+=1
        elif((275/1920)<Data_X10.values[point10]) and (Data_X10.values[point10]<=(732/1920))and (0.5<Data_Y10.values[point10]) and (Data_Y10.values[point10]<=(1)):#A4
            c10[3]+=1
        elif((732/1920)<Data_X10.values[point10]) and (Data_X10.values[point10]<=(1188/1920))and (0.5<Data_Y10.values[point10]) and (Data_Y10.values[point10]<=(1)):#A5
            c10[4]+=1
        elif((1188/1920)<Data_X10.values[point10]) and (Data_X10.values[point10]<=(1645/1920)) and (0.5<Data_Y10.values[point10]) and (Data_Y10.values[point10]<=(1)):#A6
            c10[5]+=1
...
Ses1_LRPD=Slides1_Ses_2.loc[:,['Users','USER','MEDIA_NAME','LPD','RPD']]
#-----fileter the gaze data only
LRPD=Ses1_LRPD.USER=='U_gaze'
LRPD_gaze=Ses1_LRPD[LRPD]
LRPD_gaze.to_csv('Exported_Dataset_Ses_2/LRPD_gaze.csv',index=False)

#locating and Selecting the 2 LPD and RPD features  
Ses1_LRFS=Slides1_Ses_2.loc[:,['Users','USER','MEDIA_NAME','FPOGD','LPS','RPS','FPOGX','FPOGY']]
#-----fileter the fixation data only
LRFS=Ses1_LRFS.USER=='U_fix'
LRFS_fix=Ses1_LRFS[LRFS]
LRFS_fix.to_csv('Exported_Dataset_Ses_2/LRFS_fix.csv',index=False)
...
df_fixation_Area.to_csv('Exported_Dataset_Ses_2/df_fixation_Area.csv',index=False)
stats_lrpd_data.to_csv('Exported_Dataset_Ses_2/stats_lrpd_data.csv',index=False)
stats_flr_data.to_csv('Exported_Dataset_Ses_2/stats_flr_data.csv',index=False)

fixation_Area=pd.read_csv('Exported_Dataset_Ses_2/df_fixation_Area.csv')
lrpd_data=pd.read_csv('Exported_Dataset_Ses_2/stats_lrpd_data.csv')
flr_data=pd.read_csv('Exported_Dataset_Ses_2/stats_flr_data.csv')

Data2=[fixation_Area,lrpd_data,flr_data]
Ses_Data_2=pd.concat(Data2, axis=1)
Ses_Data_2.to_csv('Exported_Dataset_Ses_2/Ses_Data_2.csv',index=False)
All_DS_Ses_2=pd.read_csv('Exported_Dataset_Ses_2/Ses_Data_2.csv')
All_DS_Ses_2.drop(['Testers_lrpd','Medias_lrpd','Testers_flr','Medias_flr'], axis=1, inplace=True)
#All_dataStat_Ses_1.drop(['DataType','MEDIA_NAME_FLR','UsersName_FLR','DataType_FLR'], axis=1, inplace=True)
All_DS_Ses_2.to_csv('Exported_Dataset_Ses_2/All_DS_Ses_2.csv',index=False)