...
for j in range(len(c)):
    ...
    for t in range(len(list_of_users)):
        ...
        for itr in range(iter_no):   
            ...
            #X_testD1_rfe=svc_rfe.transform(X_testD1)
            ...
            Patt_OutputsSVC=open("Result_Met2_Pattern_Ses13_train\pattern_OutPutNorm_SVM_Kbest_Ver2.txt","a+")
...
tempAver_PatternM2.to_csv('Result_Met2_Pattern_Ses13_train/tempAver_PatternM2.csv')
df_perfIndicators.to_csv('Result_Met2_Pattern_Ses13_train/df_perfIndicators.csv')
Data=[df_acc,df_perfIndicators]
Data_Pattern_Verfi_Meth2=pd.concat(Data,axis=1)
Data_Pattern_Verfi_Meth2.to_csv('Result_Met2_Pattern_Ses13_train/Data_Pattern_Verfi_Meth2.csv')

classAccuT_method2=classAccuT
#classAccuT_method2.to_csv('Result_Met2_Pattern_Ses13_train/classAccuT_method2.csv')